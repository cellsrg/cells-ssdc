...
public final class DataLoader
{
    ...
    private BorderType convertBorderType( short originalExcelBorderType )
    {
        ...
        {
            case CellStyle.BORDER_NONE                : return BorderType.NONE;
            case CellStyle.BORDER_THIN                : return BorderType.THIN;
            case CellStyle.BORDER_MEDIUM              : return BorderType.MEDIUM;
            case CellStyle.BORDER_DASHED              : return BorderType.DASHED;
            case CellStyle.BORDER_HAIR                : return BorderType.HAIR;
            case CellStyle.BORDER_THICK               : return BorderType.THICK;
            case CellStyle.BORDER_DOUBLE              : return BorderType.DOUBLE;
            case CellStyle.BORDER_DOTTED              : return BorderType.DOTTED;
            case CellStyle.BORDER_MEDIUM_DASHED       : return BorderType.MEDIUM_DASHED;
            case CellStyle.BORDER_DASH_DOT            : return BorderType.DASH_DOT;
            case CellStyle.BORDER_MEDIUM_DASH_DOT     : return BorderType.MEDIUM_DASH_DOT;
            case CellStyle.BORDER_DASH_DOT_DOT        : return BorderType.DASH_DOT_DOT;
            case CellStyle.BORDER_MEDIUM_DASH_DOT_DOT : return BorderType.MEDIUM_DASH_DOT_DOT;
            case CellStyle.BORDER_SLANTED_DASH_DOT    : return BorderType.SLANTED_DASH_DOT;
            default                                   : return null;
        }
    }
    ...
    private HorzAlignment getHorzAlignment( short originalExcelHorzAlignment )
    {
        ...
        {
            case CellStyle.ALIGN_GENERAL          : return HorzAlignment.GENERAL;
            case CellStyle.ALIGN_LEFT             : return HorzAlignment.LEFT;
            case CellStyle.ALIGN_CENTER           : return HorzAlignment.CENTER;
            case CellStyle.ALIGN_RIGHT            : return HorzAlignment.RIGHT;
            case CellStyle.ALIGN_FILL             : return HorzAlignment.FILL;
            case CellStyle.ALIGN_JUSTIFY          : return HorzAlignment.JUSTIFY;
            case CellStyle.ALIGN_CENTER_SELECTION : return HorzAlignment.CENTER_SELECTION;
            default                               : return null;
        }
    }
    ...
    private VertAlignment getVertAlignment( short originalExcelVertAlignment )
    {
        ...
        {
            case CellStyle.VERTICAL_TOP     : return VertAlignment.TOP;
            case CellStyle.VERTICAL_CENTER  : return VertAlignment.CENTER;
            case CellStyle.VERTICAL_BOTTOM  : return VertAlignment.BOTTOM;
            case CellStyle.VERTICAL_JUSTIFY : return VertAlignment.JUSTIFY;
            default                         : return null;
        }
    }
